...
from cardiotensor.export import vtk_writer
...
def script():
    ...
    parser.add_argument('--start_index', type=int, default=0, help='Start index for volume subset.')
    parser.add_argument('--end_index', type=int, default=None, help='End index for volume subset.')
    parser.add_argument('--bin', type=int, default=1, help='Binning factor for volume reduction.')
